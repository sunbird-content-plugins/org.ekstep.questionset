describe('org.ekstep.questionset', function() {
  ...
  beforeEach(function() {
    ...
    spyOn(questionSetPlugin, 'resetListeners').and.callThrough();
    spyOn(questionSetPlugin, 'removeDuplicateEventListeners').and.callThrough();
    spyOn(questionSetPlugin, 'renderQuestion').and.callThrough();
  ...
  describe("resetQS", function() {
    it('should remove Duplicate Event Listeners', function() {
      questionSetPlugin.resetQS();
      expect(questionSetPlugin.removeDuplicateEventListeners).toHaveBeenCalled();
    });
  });
  ...
  describe("renderPrevQuestion", function() {
    beforeEach(function() {
      ...
      questionSetPlugin.renderQuestion(question1);
      questionSetPlugin.setRendered(question1);
      questionSetPlugin._renderedQuestions.push(question1);
      question2 = {
        "id": "514d0902-1566-453b-b6ee-6a263d2209b9",
        "type": "mtf",
        "pluginId": "org.ekstep.questionset.quiz",
      ...
      questionSetPlugin.renderQuestion(question2);
      questionSetPlugin.setRendered(question2);
      questionSetPlugin._renderedQuestions.push(question2);
      spyOn(OverlayManager, "navigatePrevious");
    });

    it('should set render Prev Question', function() {
      questionSetPlugin.prevQuestion();
      expect(questionSetPlugin.renderPrevQuestion).toHaveBeenCalled();
    });
    it('should get previous question', function() {
